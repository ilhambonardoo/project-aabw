...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h5 class="fw-bold text-dark mb-3">Jurnal Penyesuaian</h5>
        </div>
    </div>
            ...
            <form method="get" class="row g-3 align-items-end">
                ...
                <div class="col-md-4">
                    ...
                    <?php if ($tgl_awal && $tgl_akhir): ?>
                        <a href="/jurnal-penyesuaian/cetak-pdf?tgl_awal=<?= urlencode($tgl_awal) ?>&tgl_akhir=<?= urlencode($tgl_akhir) ?>" 
                    ...
                    <?php if (empty($jurnal)): ?>
                        <tr>
                            <td colspan="5" class="text-center py-4 text-muted">
                                <i class="bi bi-inbox"></i> Tidak ada data jurnal penyesuaian
                            </td>
                        </tr>
                    <?php else: ?>
