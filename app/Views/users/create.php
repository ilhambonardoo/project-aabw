        ...
        <div class="card-body p-4">
            <form action="/users/store" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= session('errors.nama_pengguna') ? 'is-invalid' : '' ?>" id="nama_pengguna" name="nama_pengguna" placeholder="Contoh: antariksa" value="<?= old('nama_pengguna') ?>" required autofocus>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= session('errors.nama_lengkap') ? 'is-invalid' : '' ?>" id="nama_lengkap" name="nama_lengkap" placeholder="Contoh: Antariksa Mail" value="<?= old('nama_lengkap') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control <?= session('errors.email') ? 'is-invalid' : '' ?>" id="email" name="email" placeholder="Contoh: antariksa@example.com" value="<?= old('email') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control <?= session('errors.password') ? 'is-invalid' : '' ?>" id="password" name="password" placeholder="Masukkan password" value="<?= old('password') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select <?= session('errors.role') ? 'is-invalid' : '' ?>" id="role" name="role" required>
                        ...
                        <option value="Ketua Yayasan" <?= old('role') === 'Ketua Yayasan' ? 'selected' : '' ?>>Ketua Yayasan</option>
                        ...
                        <option value="Bendahara Pendidikan" <?= old('role') === 'Bendahara Pendidikan' ? 'selected' : '' ?>>Bendahara Pendidikan</option>
                        <option value="Ketua Majelis Talim" <?= old('role') === 'Ketua Majelis Talim' ? 'selected' : '' ?>>Ketua Majelis Talim</option>
                        <option value="Bendahara Majelis Talim" <?= old('role') === 'Bendahara Majelis Talim' ? 'selected' : '' ?>>Bendahara Majelis Talim</option>
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select <?= session('errors.bidang') ? 'is-invalid' : '' ?>" id="bidang" name="bidang" required>
                        ...
                        <option value="Semua" <?= old('bidang') === 'Semua' ? 'selected' : '' ?>>Semua</option>
                        ...
                        <option value="Majelis_Talim" <?= old('bidang') === 'Majelis_Talim' ? 'selected' : '' ?>>Majelis Talim</option>
                    </select>
