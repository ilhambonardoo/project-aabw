...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h5 class="fw-bold text-dark mb-3">Neraca Saldo Disesuaikan</h5>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="get" class="row g-3 align-items-end">
                ...
                <div class="col-md-6">
                    ...
                    <a href="/neraca-saldo-disesuaikan/cetak-pdf?bulan=<?= $bulan ?>&tahun=<?= $tahun ?>" 
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                        ...
                        <?php if (empty($neraca)): ?>
                            <tr>
                                <td colspan="5" class="text-center py-4 text-muted">
                                    <i class="bi bi-inbox"></i> Tidak ada data neraca saldo disesuaikan
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php $no = 1; ?>
                    ...
                    <tfoot class="table-dark border-top border-top-2">
                        <tr>
                            <td colspan="3" class="ps-4 fw-600 text-white">TOTAL</td>
